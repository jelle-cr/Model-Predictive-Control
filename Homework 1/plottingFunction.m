function plottingFunction(constraint,font,thickness,t,xk,uk,yk,ref1,ref2)
    ...
    stairs(0:t,yk(:,1:length(yk))',LineWidth=thickness);
    ylim([-2 12]);
